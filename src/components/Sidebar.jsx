...
//         </NavLink>
//         {/* Optional preview route (kept if you still use /dashboard/invoice with state) */}

//         {/* <NavLink to="/dashboard/invoice" className={({isActive}) => `${linkBase} ${isActive ? linkActive : ""}`}>
//           <FiFile className="text-xl" /> {!collapsed && <span>Invoice (Preview)</span>}
//         </NavLink> */}

//         {/* NEW: Invoices list + manage/edit */}
...
//         {/* <NavLink to="/dashboard/invoices" className={({isActive}) => `${linkBase} ${isActive ? linkActive : ""}`}>
//           <FiEdit className="text-xl" /> {!collapsed && <span>Edit Invoices</span>}
//         </NavLink> */}
