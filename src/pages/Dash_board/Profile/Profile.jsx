...
// import { FiMail, FiPhone, FiShield, FiUser, FiBriefcase, FiLock } from "react-icons/fi";
// import { changePassword, getProfile, buildMediaUrl,updateMyProfile } from "../../../services/profile";
...
//   if (err) {
//     return (
//       <div className="rounded-lg bg-white p-6 shadow text-rose-700">
//         {err}
//       </div>
//     );
//   }
...
//       {/* Future: Profile picture upload (not implemented because API isn’t provided) */}
//       <div className="rounded-xl border bg-white p-5 shadow-sm">
//         <h3 className="text-base font-semibold text-gray-900 mb-2">Profile picture</h3>
//         <p className="text-sm text-gray-600">
//           Displaying your current profile picture. Upload isn’t enabled because the API wasn’t provided. 
//           When you add an upload endpoint, we’ll wire it here.
//         </p>
//         <div className="mt-4">
//           {profile.profile_picture ? (
//             <img
//               src={profile.profile_picture}
//               alt={fullName}
//               className="h-28 w-28 rounded-xl object-cover ring-1 ring-gray-200"
//             />
//           ) : (
//             <div className="h-28 w-28 rounded-xl bg-gray-100 flex items-center justify-center text-xl text-gray-500">
//               {initials}
//             </div>
//           )}
//         </div>
...
// src/pages/Dash_board/Profile/Profile.jsx
import { useEffect, useMemo, useState } from "react";
import {
...
export default function Profile() {
  ...
  //     // Only append fields that changed / are present
  ...
  //     // If nothing changed, just show OK
  //     if ([...fd.keys()].length === 0) {
  //       setSaveOk("Nothing to update.");
  //     } else {
  //       await updateMyProfile(fd); // PATCH /update-profile/ (multipart)
  ...
  //         ...p,
  //         ...form,
  //         profile_picture: picFile ? picPreview : p.profile_picture,
  //       }));
  //     }
  //   } catch (e1) {
