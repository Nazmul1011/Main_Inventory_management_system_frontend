// // src/pages/Dash_board/Dashboard.jsx
...
// // (UI comps – keep as in your project)
// import Sidebar from "../../components/Sidebar";
// import Header from "../../components/Header";
// import StatCard from "../../components/Statcard";

// // API layer (you can point these to your actual endpoints)
// import {
//   getKpis,
//   getRecentSales,
//   getLowStock,
//   getTopProducts,
// } from "../../services/dashboard"; // create these or adjust paths
...
//   // === STATE (real data if available; else DUMMY) ===
...
//   // === DUMMY DATA (delete when backend wired) ===
//   /* DUMMY_START: remove these when your endpoints return real data */
//   const DUMMY_STATS = [
//     { title: "Total Products", value: "1,250", change: "+8%", icon: <FiPackage /> },
//     { title: "Total Stock Value", value: "$250,000", change: "+10%", icon: <FiDollarSign /> },
//     { title: "Total Suppliers", value: "35", change: "+3%", icon: <FiTruck /> },
//     { title: "Low-Stock Items", value: "15", change: "-3%", icon: <FiAlertTriangle /> },
//   ];

//   const DUMMY_STOCK_VALUE = {
...
//     { name: "Product A", category: "Electronics", sold: 350, revenue: "$12,000" },
//     { name: "Product B", category: "Grocery", sold: 290, revenue: "$8,500" },
//     { name: "Product C", category: "Stationery", sold: 180, revenue: "$4,300" },
//     { name: "Product D", category: "Clothing", sold: 160, revenue: "$3,900" },
//     { name: "Product E", category: "Electronics", sold: 120, revenue: "$3,200" },
//   ];
//   /* DUMMY_END */
...
//         // Try fetching real KPIs
//         // expected shape (customize if needed):
//         // { total_products, total_stock_value, total_suppliers, low_stock_items }
//         let kpis;
//         try {
//           const { data } = await getKpis(); // GET /dashboard/summary/
//           kpis = data;
//         } catch {
//           // fallback to DUMMY cards
//           setStats(DUMMY_STATS);
//         }
//         if (kpis) {
//           setStats([
//             { title: "Total Products", value: String(kpis?.total_products ?? "-"), change: "", icon: <FiPackage /> },
//             { title: "Total Stock Value", value: formatCurrency(kpis?.total_stock_value), change: "", icon: <FiDollarSign /> },
//             { title: "Total Suppliers", value: String(kpis?.total_suppliers ?? "-"), change: "", icon: <FiTruck /> },
//             { title: "Low-Stock Items", value: String(kpis?.low_stock_items ?? "-"), change: "", icon: <FiAlertTriangle /> },
//           ]);
//         }

//         // Try sales trend (7 days)
//         // expected: [{label:'Mon', amount:123}, ...]
//         try {
//           const { data } = await getRecentSales(7); // GET /sales/recent/?limit=7
//           const labels = (data?.results || data || []).map((d) => labelFromDate(d?.date || d?.created_at));
//           const amounts = (data?.results || data || []).map((d) => Number(d?.total ?? d?.amount ?? 0));
//           setSalesTrendData({
//             labels: labels.length ? labels : DUMMY_SALES_TREND.labels,
//             datasets: [
//               {
//                 label: "Sales (USD)",
//                 data: amounts.length ? amounts : DUMMY_SALES_TREND.datasets[0].data,
//                 borderColor: "#4896FE",
//                 backgroundColor: "#4896FE",
//                 tension: 0.3,
//                 fill: false,
...
//           });
//         } catch {
//           setSalesTrendData(DUMMY_SALES_TREND);
//         }

//         // Try stock value by month (if you have an endpoint; else keep dummy)
//         // You can replace this with your monthly sales/stock API when ready
//         setStockValueData(DUMMY_STOCK_VALUE);

//         // Category distribution (if you have a report; else keep dummy)
//         setCategoryDistributionData(DUMMY_CATEGORY_DIST);

//         // Top products (for table)
//         try {
//           const { data } = await getTopProducts(5); // GET /reports/top-products/?limit=5
...
//         setStats((s) => (s.length ? s : DUMMY_STATS));
//         setStockValueData((d) => d || DUMMY_STOCK_VALUE);
//         setSalesTrendData((d) => d || DUMMY_SALES_TREND);
//         setCategoryDistributionData((d) => d || DUMMY_CATEGORY_DIST);
//         setTopProducts((t) => (t.length ? t : DUMMY_TOP_PRODUCTS));
//       }
//     })();
...
//               </div>
//             ))}
//             {/* DUMMY_NOTE: rows above are replaced automatically when API returns data */}
//           </div>
//         </div>
//       </div>
//     </div>
